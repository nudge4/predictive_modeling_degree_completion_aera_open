...
merge m:1 vccsid using "${main_dir}/intermediate_files/truncation_nth_df.dta", keep(2 3) nogen
...
sort vccsid
drop pell_ind
save "${main_dir}/intermediate_files/full_data_truncated.dta", replace
...
save "${main_dir}/intermediate_files/full_data_truncated_no_term_specific.dta", replace
